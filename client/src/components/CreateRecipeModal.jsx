...
//     useEffect(() => {
//         // Загружаем данные только при открытии модального окна и если ещё не загружали
//         if (open && !initialLoad) {
...
//         // Сбрасываем флаг загрузки при закрытии модального окна
//         return () => {
//             if (!open) {
        ...
        try {
            const recipeData = {
                ...
                steps: formData.steps.map(step => ({
                    ...step,
                    image: step.image ? step.image.name : null // или другой идентификатор
                }))
            };
